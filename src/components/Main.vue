<template>
  <main class="container" id="main" ref="main">
    <div class="main-inner">
      <div class="main-text">
        ...
        <p
          ...
          Hi, i’m Maga Lutfullaev. I’m working since 2020 as Front-End developer.
        </p>
      </div>
      <div
        v-motion
        :initial="{ opacity: 0, x: 30, backgroundSize: '100%' }"
        :enter="{ opacity: 1, x: 0, backgroundSize: '110%', transition: {duration: 600}}"
        :delay="200"
        class="bg-img main-ava"></div>
    </div>
    <div class="socials">
      <a
        v-motion
        ...
        target="_blank"
        href="https://t.me/magalutfullaev">
      ...
      <a
        ...
        :enter="{ opacity: 1, x: 0, transition: {duration: 300, delay: 500}}"
        target="_blank"
        href="https://github.com/magalutfullaev">
